...
"a circular structure will be used to drawn the network. Circular structures tend to work better for visualizing the entire season,
...
p(align = "left", tags$b(tags$u("Glossary")), 
  ...
  tags$li(tags$b(a("Authority Score MVP:", href = "https://en.wikipedia.org/wiki/HITS_algorithm")), tags$br(),  "Most important reciever of assists in the network (Scale 0-1)"),
